    ...
    switch (action) {
      ...
      case 'enterText':
        try {
          ...
          if (!isVisible) {
            log(`Warning: Element ${args[1]} is not visible, but attempting to fill anyway`);
          }
          ...
          log(`Successfully entered text into ${args[1]}, value is now: "${value}"`);
          ...
          logError(`Failed to enter text "${args[0]}" into element "${args[1]}":`, err.message);
