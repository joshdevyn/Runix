...
describe('AgentDriver - Real Implementation Tests', () => {
  ...
  describe('capabilities', () => {
    it('should return correct capabilities', () => {
      ...
      expect(capabilities.description).toContain('Agent-driven automation system');
  ...
  describe('error handling and edge cases', () => {    it('should handle execution before initialization', async () => {
